...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { description: @achievement.description, resume_id: @achievement.resume_id, year: @achievement.year }
    end
  ...
  test "should update achievement" do
    put :update, id: @achievement, achievement: { description: @achievement.description, resume_id: @achievement.resume_id, year: @achievement.year }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
